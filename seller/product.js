...
$(document).on("submit", "#product-upload-form", function (e) {
    ...
    let url_str = `./control/product_ctrl.php?edit=${p_id}&upload_item`;
    e.preventDefault();
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (Number(data) === 1) {
                ...
                (Number(data) === 9) ? snacbar("Image too big or not supported") : snackbar("Something went wrong..Refresh Page");
            }
        }
    });
});
