...
if (isset($_SESSION['courier_id'])) {
    if (isset($_GET['store'])) {
        ...
        $store_query .= (isset($_GET['rtrn_rqst']))?"return_requests FROM client_storage WHERE return_requests != '' AND ":"pending_orders FROM client_storage WHERE pending_orders != '' AND ";
        $store_query .= "latitude=$_SESSION[d_latitude] AND longitude=$_SESSION[d_longitude]";
